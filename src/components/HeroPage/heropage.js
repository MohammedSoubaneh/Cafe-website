      ...
      <div className='fullPage'>
        <Carousel>
          <Carousel.Item interval={600000}>
            <img className='aBlock' src={slideOne} alt='First slide' />
            <Carousel.Caption>
              <div className='title'>
                <h3 className='firstTitle'>New Online Store</h3>
                <h2 className='firstSubTitle'>
                  Discover the new online shopping experience
                </h2>
                <div className='visitShop'>
                  <Link
                    to='onlineStore'
          ...
          <Carousel.Item interval={60000}>
            <img className='bBlock' src={slideTwo} alt='Second slide' />
            <Carousel.Caption>
              <div className='title'>
          ...
          <Carousel.Item>
            <img className='cBlock' src={slideThree} alt='Third slide' />
            <Carousel.Caption>
